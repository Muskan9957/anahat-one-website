export function AboutSection() {
  return (
    <section id="about" className="scroll-mt-20 border-t border-border py-14 md:py-32">
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        <div className="grid gap-6 md:grid-cols-12 md:gap-16">
          ...
          <div className="md:col-span-7">
            <p className="text-pretty text-base leading-relaxed md:text-lg text-muted-foreground">
            ...
            <div className="mt-6 grid grid-cols-3 gap-4 border-t border-border pt-5 md:mt-10 md:gap-8 md:pt-8">
              {[
                ...
                <div key={item.label}>
                  <div className="font-serif text-2xl font-medium text-primary md:text-4xl">{item.value}</div>
